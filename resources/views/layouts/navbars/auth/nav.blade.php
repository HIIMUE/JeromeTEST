            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
                ...
                <li class="mb-2">
                    ...
                    <div class="d-flex py-1">
                        <div class="my-auto">
                        <img src="../assets/img/team-2.png" class="avatar avatar-sm  me-3 ">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                            <span class="font-weight-bold">Deceased</span> To be transfered
                        </h6>
                ...
                <li class="mb-2">
                    ...
                    <div class="d-flex py-1">
                        <div class="my-auto">
                        <img src="../assets/img/team-2.png" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                            <span class="font-weight-bold">Deceased</span> to be transfered
