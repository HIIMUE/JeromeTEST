...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">Lugait Cemetery</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">View & edit page</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
          ...
          <span class="nav-link-text ms-1">Deceased </span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('virtual-reality') ? 'active' : '') }}" href="{{ url('virtual-reality') }}">
          ...
          <span class="nav-link-text ms-1">Lot</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-link mb-0">
        <a href="h" class="btn btn-primary btn-md active px-5 text-white" target="_blank" role="button" aria-pressed="true">
            Contract</a>
      </li>
    </ul>
  </div>
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          <h6 class="text-white up mb-0">Welcome Admin</h6>
          <p class="text-xs font-weight-bold">Cemetery Information Management System</p>
          <a href="https://www.facebook.com/places/Things-to-do-in-Lugait-Misamis-Oriental/105689252799250" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Lugait Page</a>
        </div>
      </div>
    </div>
  </div>
